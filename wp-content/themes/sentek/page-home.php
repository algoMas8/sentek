        ...
        <div class="icon-full-width-wrapper">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <?php if($i == 3){ ?>
                    <!-- close first row so second can have a full width white background -->
        ...
        <div class="container fourth-home-band">
            ...
            <div class="row">
                ...
                <div class="col-md-6 home-news-col">
                    ...
                    <?php $backgroundImg = wp_get_attachment_image_src( get_post_thumbnail_id($post->ID), 'full' );?>
                    <a href="<?php echo the_permalink();?>">
                        <div class="feat-img-container" style="background: url('<?php echo $backgroundImg[0]; ?>') no-repeat; "></div>
                    </a>
                    <br />
                    <?php the_excerpt();?>
